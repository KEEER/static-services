...
var styles = [['1-1', '1-2', '1-3'], ['2'], ['3-1', '3-2'], ['4']];
var imageUrl = function imageUrl(id) {
  return "https://keeer-pub.oss-cn-beijing.aliyuncs.com/rdfzgkavt/2023/".concat(id, ".webp");
};
...
var _loop = function _loop(key) {
  ...
  transparencySliders[key].listen('MDCSlider:input', debounce(function () {
    ...
    // FIXME
    if (key === '1-1') {
      transparentImages['1-3'].style.opacity = opacity;
      transparencies['1-3'] = opacity;
    }
  }, debounceTime));
};
